...
<script src="/petstore/js/bootstrap.min.js"></script>
  ...
  <body>
    ...
    <form action="<c:url value='/admin/adminCategoryServlet?method=edit&cid=${category.cid }'/>" method="post">
    	<input type="hidden" name="cid" value="${category.cid }" />
    	<div class="form-group">
    <label for="exampleInputName2">分类名称</label>
    <input type="text" name="cname" value="${category.cname }" class="form-control" id="exampleInputName2"/>
    	  </div>
    	<input type="submit" value="修改分类" class="btn btn-default"/>
    </form>
  </body>
</html>
